...
async function readPrivateNumber(): Promise<void> {
    try {
        ...
        const contractAddress: string = "0x78953065c5bbD6035D58135a73f2caa9E050A373";
        ...
        console.error("Error reading private number:", error);
    }
}

// Run the function
readPrivateNumber().catch(console.error);